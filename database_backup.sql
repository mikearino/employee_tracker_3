...
--
-- Name: employees_projects_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--
...
ALTER TABLE public.employees_projects_id_seq OWNER TO "Guest";

--
-- Name: employees_projects_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--
...
--
-- Name: employees_projects id; Type: DEFAULT; Schema: public; Owner: Guest
--
...
14	Dsadsa	2019-08-07 22:12:18.746564	2019-08-07 22:12:42.436089
\.
...
16	Mikes		14	2019-08-07 22:12:26.067702	2019-08-07 22:12:59.413492
\.
...
COPY public.employees_projects (id, project_id, employee_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.divisions_id_seq', 14, true);
...
--
-- Name: employees_projects_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Guest
--

SELECT pg_catalog.setval('public.employees_projects_id_seq', 1, false);
...
--
-- Name: employees_projects employees_projects_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest
--
